package com.noletotech.usuario.infrastructure.security;

import com.noletotech.usuario.infrastructure.exceptions.dto.ErrorResponseDTO;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        try {
            ...
            response.getWriter().write(buildError(HttpStatus.UNAUTHORIZED.value(), "Token expirado", request.getRequestURI(), e.getMessage()));
